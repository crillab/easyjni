...
hidden if the `crillab-easyjni_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `crillab-easyjni_DEVELOPER_MODE` to the configure
